...
All improvements are additive and backward-compatible: the script runs
identically to v1 when --nav and --clk are omitted.
...
Typical use:
    python gnss_offline_path.py \
        ...
        --sp3 igr22896.sp3 \
        --clk igr22896.clk \
        --nav BRDC00IGS_R_20260800000_01D_MN.rnx \
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--sp3", required=True,
                   help="Path to SP3 precise orbit file")
    p.add_argument("--clk", default=None,
                   help="[NEW] Path to IGS precise clock file (.clk). "
                        "Strongly recommended for best accuracy. "
                        "Download from IGS e.g. igr<WWWWD>.clk or igs<WWWWD>.clk")
